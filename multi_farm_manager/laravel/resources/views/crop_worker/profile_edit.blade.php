                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input class="text" type="text" name="name" placeholder="re-name"></input>
                                            </div>
                                        </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                            <input class="email" type="email" name="email" placeholder="type email"></input>
                                            </div>
                                        </div>
                            </div>
                            <div >
