...
<html lang="en">
<head>
  <title>Crop Worker Dashboard</title>
  <meta charset="utf-8">
  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        <li><a href="/time/schedule">Seeding Time Schedule</a></li>

        <li><a href="/ordering/seed">Ordering Seeds</a></li>

        <li><a href="/selling/crop">Selling Crops</a></li>
        <li><a href="*">Cow feed</a></li>
        <li><a href="/edit/profile">Profile Edit</a></li>
