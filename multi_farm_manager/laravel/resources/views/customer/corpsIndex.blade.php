...
<body>
  ...
  <div class="container-fluid">
    <span class="navbar-brand"><b> Corps </b></span>
...
<br>
<div align='right'><a href="/customer/crops/cart" class="btn btn-primary">View Cart</a></div>
<br><br>
...
<tbody>
  ...
  <tr>
    ...
    <td>{{$item['price']}}</td>
    <td><a href="/customer/crops/details/{{$item['i_id']}}"><i class="fa fa-pencil"></i>Details</a></td>
  </tr>
  @endforeach
