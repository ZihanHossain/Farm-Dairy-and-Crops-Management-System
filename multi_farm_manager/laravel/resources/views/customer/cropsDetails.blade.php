...
<nav class="navbar navbar-dark bg-dark">
  <div class="container-fluid">
    <span class="navbar-brand"><b> Details </b></span>
...
<tbody>
  ...
  <tr>
    <td>{{$item['i_id']}}</label></td>
    <td>{{$item['name']}}</td>
    <td>{{$item['price']}}</td>
    <td>Available {{$pItem['amount']}} || Order <input type="number" name="amount"></input></td>
    <td><button type="submit" ><i class="fa fa-pencil"></i>Add to Cart</button></td>
  </tr>
