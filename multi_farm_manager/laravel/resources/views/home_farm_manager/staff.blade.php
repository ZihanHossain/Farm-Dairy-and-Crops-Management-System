                ...
                <ul class="nav side-menu">
                  ...
                  <li class="active"><a><i class="fa fa-list-alt"></i> Information <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li class="active"><a href="staffinfo.php">Staff</a></li>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Staff Information <small>Table</small></h2>
                            ...
                            <div class="x_content">
                              <br />
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                  <input type="text" name="name" class="form-control has-feedback-left" id="inputSuccess2" placeholder="Staff Name">
                                  <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                </div>

                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                  <input type="email" name="email" class="form-control" id="inputSuccess3" placeholder="Email">
                                  <span class="fa fa-envelope form-control-feedback right" aria-hidden="true"></span>
                                </div>

                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                  <input type="text" name="user_name" class="form-control has-feedback-left" id="inputSuccess2" placeholder="Username">
                                  <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                                </div>

                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                  <input type="password" name="password" class="form-control" id="inputSuccess3" placeholder="Password">
                                  <span class="fa fa-lock form-control-feedback right" aria-hidden="true"></span>
                                </div>

                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                  <input type="number" name="salary" class="form-control" id="inputSuccess3" placeholder="Salary">
                                  <span class="fa fa-lock form-control-feedback right" aria-hidden="true"></span>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                  <select name="shift_id" class="form-control">
                                      ...
                                      @foreach ($shift_details as $shift_detail)
                                        <option value="{{$shift_detail['sh_id']}}">{{$shift_detail['shift_name']}}</option>
                                      @endforeach  
                                  </select>
                                </div>
                                ...
                                <div class="mb-3  form-group has-feedback">
                                  <span>Type</span>
                                  <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="type" id="inlineRadio1" value="dairy">
                                    <label class="form-check-label" for="inlineRadio1">Dairy Farm</label>
                                  </div>
                                  <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="type" id="inlineRadio2" value="crop">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><center><img src="{{ url('images/staff_profile_picture/'.$user['image']) }}" width="40" alt="Avatar" align="center"></center></td>
                          <td>{{$user['name']}}</td>
                          <td>{{$user['email']}}</td>
                          <td>{{ucfirst($user['type'])}}</td>
                          <td>{{$user['salary']}}</td>
                          <td>*******</td>
                          <td><a href="/home/dairyfarm/staff/details/{{$user['u_id']}}"><i class="fa fa-pencil"></i></a> <a href="/home/dairyfarm/staff/delete/{{$user['u_id']}}"><i class="fa fa-trash"></i></a> </td>
                        </tr>
                        @endforeach
