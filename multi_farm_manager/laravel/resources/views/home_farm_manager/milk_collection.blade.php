              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-money"></i> Sale <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="44">Dairy Items Sales Report</a></li>
                      <li><a href="salecow.php">Cow</a></li>
                      <li><a href="salecowreport.php">Cow Report</a></li>
                    </ul>
                  </li>
                  <li class="active">
                    <a href=""><i class="fa fa-shopping-cart"></i> Milk Collection </a>
                  </li>
                  <li class="">
                      ...
                      <tbody>
                        ...
                        @foreach ($cows as $cow)
                          <tr>
                            ...
                            <td>{{$cow['co_id']}}</td>
                            <td>{{$today_milking_amount[$i]}} Ltr.</td>
                            <td>{{$total_milking_amount[$i]}} Ltr.</td>
                            <td><a href="/home/milk_collection/details/{{$cow['co_id']}}"><i class="fa fa-pencil"></i></a></td>
                          </tr>
                          @php
                            $i += 1;
                          @endphp
