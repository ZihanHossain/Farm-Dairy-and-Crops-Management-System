          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Cow Feeds Information <small>Table</small></h2>
                    ...
                    <form class="form-label-left input_mask" method="POST" action="/home/cow_feeds/add_feed">
                          ...
                          <div class="x_content">
                            <br/>
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                  <input type="text" name="name" class="form-control has-feedback-left" id="inputSuccess2" placeholder="Item Name">
                                ...
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                  <input type="text" name="amount" class="form-control has-feedback-left" id="inputSuccess4" placeholder="Amount">
                                  <span class="fa fa-paw form-control-feedback left" aria-hidden="true"></span>
                                </div>

                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                  <input type="text" name="price" class="form-control has-feedback-left" id="inputSuccess4" placeholder="Price">
                                  <span class="fa fa-paw form-control-feedback left" aria-hidden="true"></span>
                                </div>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        @foreach ($cow_feeds as $cow_feed)
                        <tr>
                          <td>{{ucfirst($cow_feed['name'])}}</td>
                          <td><b style="color: brown">Grade {{ucfirst($cow_feed['quality'])}}</b></td>
                          <td>{{$cow_feed['amount']}}</td>
