          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Shift Information <small>Table</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{ucfirst($shift_detail['shift_name'])}}</td>
                          <td>{{$shift_detail['starting_time']}}</td>
                          <td>{{$shift_detail['ending_time']}}</td>
                          <td><button class="btn btn-info btn-sm"  id="edit"><i class="fa fa-pencil"></i></button> <button class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> </button></td>
                        </tr>
                        @endforeach
