...
<div class="container">
  <div class="left">
    ...
    <a href="/home"><h1>Home</h1></a>
      <h2 class="animation a1">SignUp Here</h2>
      <h4 class="animation a2">Create New Account</h4>
    </div>
	<form method="POST">
  @csrf
    <div class="form">        
    <input type="name"  name="name"class="form-field animation a3" placeholder="Name">
      <input type="name"  name="uname"class="form-field animation a3" placeholder="UserName">
      ...
      <button type="submit" value="submit" class="animation a6">Sign Up</button>
    </div>
	</form>
  </div>
  <div class="right"></div>
