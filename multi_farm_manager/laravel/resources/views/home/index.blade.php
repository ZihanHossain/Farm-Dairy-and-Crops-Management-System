...
<html lang="en">
<head>
<title>Kazi Farms Home</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Plantation Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
...
<div class="header-top-w3layouts" id="header">
	<div class="container">
		...
		<div class="col-md-4 sign-up">
			<a href="/sign_up/form"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Sign Up</a>
			<a href="/login"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Sign In</a>
		</div>
...
<div class="header-bottom-w3">
	<div class="container">
		<div class="col-md-4 logo-agileits">
			<a href="/home"><h1>Kazi Farms</h1></a>
		</div>
		<div class="col-md-8 call-mail-agileinfo">
			...
			<div class="mail">
				<h4>Mail us</h4>
				<h3><a href="mailto:kazifarms@gmail.com">kazifarms@gmail.com</a></h3>
			</div>
			<div class="clearfix"></div>
		</div>
		<div class="clearfix"></div>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="agilefooter-bottom">
				<p>&copy; 2021 Kazi Farms. All Rights Reserved </p>
			</div>
		</div>
