...
<div class="container">
  <div class="left">
    ...
    @csrf
    <div class="form">
      <input type="text" name="uname" class="form-field animation a3" placeholder="Username">
      <input type="password" name="password" class="form-field animation a4" placeholder="Password">
      <button class="animation a6" type='submit' value='submit'>LOGIN</button>
  ...
  <p class="animation a5">New Member,Please <a href="/sign_up/form">Sign Up</a></p>
  </div>
  <div class="right"></div>
</div>
